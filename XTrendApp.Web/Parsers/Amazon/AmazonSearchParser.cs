...
//            var cards = page.Locator(AmazonSearchSelectors.ProductCard);
...
//    string baseUrl)
//        {
//            var model = new AmazonSearchModel();

//            model.Asin = await GetAsinAsync(card);

//            model.Title = await GetTitleAsync(card);

//            model.ProductUrl = await GetProductUrlAsync(
//    card,
//    baseUrl);

//            model.ImageUrl = await GetImageUrlAsync(card);

//            model.Price = await GetPriceAsync(card);

//            model.ListPrice = await GetListPriceAsync(card);

//            model.Rating = await GetRatingAsync(card);

//            model.ReviewCount = await GetReviewCountAsync(card);

//            model.BoughtLastMonthText =
//    await GetBoughtLastMonthTextAsync(card);

//            model.BoughtLastMonthCount =
//                ParseBoughtLastMonth(model.BoughtLastMonthText);

//            model.VariationCount = await GetVariationCountAsync(card);

//            return model;
//        }

//        private async Task<string> GetAsinAsync(ILocator card)
//        {
//            try
//            {
//                var links = card.Locator(AmazonSearchSelectors.Link);
...
//        private async Task<string> GetTitleAsync(ILocator card)
//        {
//            var title = await card
//                .Locator(AmazonSearchSelectors.Title)
//                .InnerTextAsync();
...
//        private async Task<string> GetImageUrlAsync(ILocator card)
//        {
//            var image = card.Locator(AmazonSearchSelectors.Image).First;
...
//        private async Task<decimal?> GetPriceAsync(ILocator card)
//        {
//            var price = card.Locator(AmazonSearchSelectors.Price).First;

//            if (await price.CountAsync() == 0)
//                return null;

//            var whole = await price
//                .Locator(".a-price-whole")
//                .InnerTextAsync();

//            var fraction = await price
...
//        private async Task<decimal?> GetListPriceAsync(ILocator card)
//        {
//            var price = card.Locator(AmazonSearchSelectors.ListPrice).First;

//            if (await price.CountAsync() == 0)
//                return null;

//            var text = await price
//                .Locator(".a-offscreen")
//                .InnerTextAsync();
...
//        private async Task<decimal?> GetRatingAsync(ILocator card)
//        {
//            var text = await TryGetInnerTextAsync(
//                card.Locator(AmazonSearchSelectors.Rating));
...
//        private async Task<int?> GetReviewCountAsync(ILocator card)
//        {
//            var text = await TryGetInnerTextAsync(
//                card.Locator(AmazonSearchSelectors.ReviewCount));
...
//        private int? ParseReviewCount(string value)
//        {
...
//        private async Task<string?> GetBoughtLastMonthTextAsync(ILocator card)
//        {
//            return await TryGetInnerTextAsync(
//                card.Locator(AmazonSearchSelectors.BoughtLastMonth));
//        }
//        private int? ParseBoughtLastMonth(string? text)
//        {
//            if (string.IsNullOrWhiteSpace(text))
//                return null;
...
//            var match = Regex.Match(text, @"([\d\.]+)\s*([KM]?)");
...
//        private async Task<int?> GetVariationCountAsync(ILocator card)
//        {
//            var item = card.Locator(AmazonSearchSelectors.VariationCount).First;
...
//        private int? ParseVariationCount(string text)
//        {
